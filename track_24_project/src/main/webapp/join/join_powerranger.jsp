			...
			<form name='joinForm' id="joinForm" method="post" action="#">
				...
				<div class="panel active" data-step="1">
					...
					<div class="row">
						...
						<div class="field">
							...
							<input type="number" name="age" id="age" placeholder="예) 25"
								min="0" max="120">
						</div>
					</div>
					...
					<div class="field">
						...
						<div class="row">
							<input type="text" name="email_1" id="email_1"
								placeholder="example"> <select name="email_2"
								id="email_2">
				...
				<div class="panel" data-step="2">
					...
					<div class="field">
						...
						<div class="phone-row">
							<input type="text" name="mobile_1" id="mobile_1" maxlength="3"
								placeholder="010"> <span class="dash">-</span> <input
								type="text" name="mobile_2" id="mobile_2" maxlength="4"
								placeholder="1234"> <span class="dash">-</span> <input
								type="text" name="mobile_3" id="mobile_3" maxlength="4"
								placeholder="5678">
						</div>
					</div>
				</div>
					...
					<div class="chip-group">
						...
						<div class="radio-group">
							<label class="radio-option"> <input type="radio"
								name="speech_style" value="formal"> <span
								class="radio-box"></span> <span class="radio-label">존댓말</span>
							</label> <label class="radio-option"> <input type="radio"
								name="speech_style" value="casual"> <span
								class="radio-box"></span> <span class="radio-label">반말</span>
							</label> <label class="radio-option"> <input type="radio"
								name="speech_style" value="mixed"> <span
								class="radio-box"></span> <span class="radio-label">상황에
									따라</span>
							</label>
						</div>
					</div>
					...
					<div class="chip-group">
						...
						<div class="checkbox-group" data-category="food">
							<div class="checkbox-item">
								...
								<label class="checkbox-label" for="food_korean"> <span
									class="checkbox-box"></span> <span>한식</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="food_japanese" name="food" value="일식">
								<label class="checkbox-label" for="food_japanese"> <span
									class="checkbox-box"></span> <span>일식</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="food_chinese" name="food" value="중식">
								<label class="checkbox-label" for="food_chinese"> <span
									class="checkbox-box"></span> <span>중식</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="food_western" name="food" value="양식">
								<label class="checkbox-label" for="food_western"> <span
									class="checkbox-box"></span> <span>양식</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="food_snack" name="food" value="분식">
								<label class="checkbox-label" for="food_snack"> <span
									class="checkbox-box"></span> <span>분식</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="food_dessert" name="food" value="디저트">
								<label class="checkbox-label" for="food_dessert"> <span
									class="checkbox-box"></span> <span>디저트</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="chip-group">
						...
						<div class="checkbox-group" data-category="drink">
							<div class="checkbox-item">
								...
								<label class="checkbox-label" for="drink_coffee"> <span
									class="checkbox-box"></span> <span>커피</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="drink_tea" name="drink" value="차">
								<label class="checkbox-label" for="drink_tea"> <span
									class="checkbox-box"></span> <span>차</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="drink_juice" name="drink" value="주스">
								<label class="checkbox-label" for="drink_juice"> <span
									class="checkbox-box"></span> <span>주스</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="drink_smoothie" name="drink"
									value="스무디"> <label class="checkbox-label"
									for="drink_smoothie"> <span class="checkbox-box"></span>
									<span>스무디</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="drink_soda" name="drink" value="탄산음료">
								<label class="checkbox-label" for="drink_soda"> <span
									class="checkbox-box"></span> <span>탄산음료</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="drink_milk" name="drink"
									value="우유/라떼"> <label class="checkbox-label"
									for="drink_milk"> <span class="checkbox-box"></span> <span>우유/라떼</span>
								</label>
							</div>
						</div>
					</div>
...
<<<<<<< HEAD
					<div class="chip-group">
						...
						<div class="checkbox-group" data-category="music">
							<div class="checkbox-item">
								<input type="checkbox" id="music_kpop" name="music"
									value="K-POP"> <label class="checkbox-label"
									for="music_kpop"> <span class="checkbox-box"></span> <span>K-POP</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="music_hiphop" name="music" value="힙합">
								<label class="checkbox-label" for="music_hiphop"> <span
									class="checkbox-box"></span> <span>힙합</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="music_ballad" name="music"
									value="발라드"> <label class="checkbox-label"
									for="music_ballad"> <span class="checkbox-box"></span>
									<span>발라드</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="music_edm" name="music" value="EDM">
								<label class="checkbox-label" for="music_edm"> <span
									class="checkbox-box"></span> <span>EDM</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="music_jazz" name="music" value="재즈">
								<label class="checkbox-label" for="music_jazz"> <span
									class="checkbox-box"></span> <span>재즈</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="music_rock" name="music" value="락">
								<label class="checkbox-label" for="music_rock"> <span
									class="checkbox-box"></span> <span>락</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="chip-group">
						...
						<div class="checkbox-group" data-category="movie">
							<div class="checkbox-item">
								...
								<label class="checkbox-label" for="movie_action"> <span
									class="checkbox-box"></span> <span>액션</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="movie_romance" name="movie"
									value="로맨스"> <label class="checkbox-label"
									for="movie_romance"> <span class="checkbox-box"></span>
									<span>로맨스</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="movie_comedy" name="movie"
									value="코미디"> <label class="checkbox-label"
									for="movie_comedy"> <span class="checkbox-box"></span>
									<span>코미디</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="movie_sf" name="movie" value="SF">
								<label class="checkbox-label" for="movie_sf"> <span
									class="checkbox-box"></span> <span>SF</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="movie_horror" name="movie" value="공포">
								<label class="checkbox-label" for="movie_horror"> <span
									class="checkbox-box"></span> <span>공포</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="movie_drama" name="movie" value="드라마">
								<label class="checkbox-label" for="movie_drama"> <span
									class="checkbox-box"></span> <span>드라마</span>
								</label>
							</div>
						</div>
					</div>
...
>>>>>>> refs/remotes/origin/안준휘
					...
					<div class="chip-group">
						...
						<div class="checkbox-group" data-category="book">
							<div class="checkbox-item">
								...
								<label class="checkbox-label" for="book_novel"> <span
									class="checkbox-box"></span> <span>소설</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="book_self" name="book" value="자기계발">
								<label class="checkbox-label" for="book_self"> <span
									class="checkbox-box"></span> <span>자기계발</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="book_economy" name="book" value="경제">
								<label class="checkbox-label" for="book_economy"> <span
									class="checkbox-box"></span> <span>경제</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="book_human" name="book" value="인문">
								<label class="checkbox-label" for="book_human"> <span
									class="checkbox-box"></span> <span>인문</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="book_comic" name="book" value="만화">
								<label class="checkbox-label" for="book_comic"> <span
									class="checkbox-box"></span> <span>만화</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="chip-group">
						...
						<div class="checkbox-group" data-category="allergy">
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_nut" name="allergy"
									value="견과류"> <label class="checkbox-label"
									for="allergy_nut"> <span class="checkbox-box"></span> <span>견과류</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_milk" name="allergy"
									value="우유"> <label class="checkbox-label"
									for="allergy_milk"> <span class="checkbox-box"></span>
									<span>우유</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_egg" name="allergy"
									value="계란"> <label class="checkbox-label"
									for="allergy_egg"> <span class="checkbox-box"></span> <span>계란</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_wheat" name="allergy"
									value="밀"> <label class="checkbox-label"
									for="allergy_wheat"> <span class="checkbox-box"></span>
									<span>밀</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_seafood" name="allergy"
									value="갑각류"> <label class="checkbox-label"
									for="allergy_seafood"> <span class="checkbox-box"></span>
									<span>갑각류</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_soy" name="allergy"
									value="대두"> <label class="checkbox-label"
									for="allergy_soy"> <span class="checkbox-box"></span> <span>대두</span>
								</label>
							</div>
							<div class="checkbox-item">
								<input type="checkbox" id="allergy_none" name="allergy"
									value="없음"> <label class="checkbox-label"
									for="allergy_none"> <span class="checkbox-box"></span>
									<span>없음</span>
								</label>
							</div>
						</div>
				...
				<!-- 버튼 -->
				<div class="actions">
					<button type="button" class="btn outline" id="prevBtn">←
						이전</button>
					<button type="button" class="btn primary" id="nextBtn">다음
						→</button>
